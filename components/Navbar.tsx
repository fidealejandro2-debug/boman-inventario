...
export default function Navbar({ perfil }: { perfil: Perfil }) {
  ...
  const modulosBase: ModuloMenu[] = [
    ...
    { id: "ventas", etiqueta: "Ventas", opciones: [
      ...
      { href: "/ventas/entregas", etiqueta: "Centro de contratos", descripcion: "Brief, abonos, vendedor y entregas", visible: (tienePermiso(perfil, "contratos.acceder") || tienePermiso(perfil, "contratos.entregar") || tienePermiso(perfil, "contratos.revertir_entrega")) && modoBoman },
