...
export default async function ContratosPage(){const perfil=await getPerfilActual();if(!tienePermiso(perfil,"produccion.acceder"))redirect("/dashboard");return <><Navbar perfil={perfil}/><main className="container"><ContratosCliente puedeEditar={tienePermiso(perfil,"contratos.editar")} puedeFinanzas={tienePermiso(perfil,"contratos.finanzas.editar")}/></main></>}
