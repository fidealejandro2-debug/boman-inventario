    ...
    exportarCSV("diferencias_conteos", conteos.flatMap((d) =>
      d.lineas
        ...
        .map((l: any) => ({
          ...
          Sistema: l.stock_sistema,
          PrimerConteo: l.cantidad_contada,
          SegundoConteo: l.cantidad_reconteo,
