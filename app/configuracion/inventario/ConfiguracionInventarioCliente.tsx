...
export default function ConfiguracionInventarioCliente() {
  ...
  return <>
    ...
    <div className="info-box" style={{ marginBottom: 14 }}><strong>Stock de seguridad:</strong> reserva mínima adicional para cubrir ventas inesperadas o retrasos. <strong>Punto de reposición:</strong> nivel que activa la sugerencia de pedir más producto; normalmente debe ser igual o mayor que el mínimo.</div>
